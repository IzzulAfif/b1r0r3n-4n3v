<!--main content start-->
		...
		<!--tab nav start-->
            <section class="panel">
                <header class="panel-heading tab-bg-light tab-right ">
                	<p class="pull-left"><b>Unit Kerja Eselon II</b></p>
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="">
                            <a data-toggle="tab" href="#fungsi-content">
                                <i class="fa fa-bar-chart-o"></i> Fungsi Eselon II
                            </a>
                        </li>
	...
	<script  type="text/javascript" language="javascript">
		$(document).ready(function() {
			...
			$("#id-content").load("<?=base_url()?>unit_kerja/eselon2/loadidentitas");
			$("#fungsi-content").load("<?=base_url()?>unit_kerja/eselon2/loadfungsi");
