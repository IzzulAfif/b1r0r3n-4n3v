    ...
    <?php if (isset($data)) : ?>
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label">Kode Visi</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control input-sm" name="kode" value="<?=$data[0]->kode_visi_e1?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">visi</label>
                <div class="col-sm-8">
                    <textarea name="visi" class="form-control"><?=$data[0]->visi_e1?></textarea>
                </div>
            </div>
