    ...
    <?php if (isset($data)) : ?>
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label">Kode Tujuan</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control input-sm" name="kode" value="<?=$data[0]->kode_tujuan_e2?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">tujuan</label>
                <div class="col-sm-8">
                    <textarea name="tujuan" class="form-control"><?=$data[0]->tujuan_e2?></textarea>
                </div>
            </div>
