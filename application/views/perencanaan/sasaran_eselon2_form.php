    ...
    <?php if (isset($data)) : ?>
            ...
            <input type="hidden" name="id" value="<?=$data[0]->kode_sasaran_e2?>" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control input-sm" name="kode" value="<?=$data[0]->kode_sasaran_e2?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">Sasaran</label>
                <div class="col-sm-8">
                    <textarea name="sasaran" class="form-control"><?=$data[0]->sasaran_e2?></textarea>
                </div>
            </div>
