<section class="panel">
	<header class="panel-heading tab-bg-light tab-right ">
		...
		<ul class="nav nav-tabs pull-right">
			...
			<li class="">
				<a data-toggle="tab" href="#emon_kegiatan-content">
	...
	<div class="panel-body">
		...
		<!--main content start-->							
			...
			<!--main content end-->
				...
				<div class="tab-pane fade" id="emon_kegiatan-content">
					<div class="row">
					<div class="col-sm-12">
						<div class="pull-left">
							  <button type="button" class="btn btn-info" id="emon-kegiatan-btn" style="margin-left:15px;">
 ...
 <script>
	$(document).ready(function(){
		...
		$("#ekstrak-kegiatan-btn").click(function(){
			//alert("Data telah diekstrak");
			var oTable = $('#emon_kegiatan-tbl').dataTable();
			$.ajax({
				type: 'POST',
				url: '<?=base_url()?>admin/ekstrak_kegiatan/ekstrak_data/<?=$tahun?>',
				cache: false,
				dataType: 'json',
