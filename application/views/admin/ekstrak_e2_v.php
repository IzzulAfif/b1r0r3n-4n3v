<section class="panel">
	<header class="panel-heading tab-bg-light tab-right ">
		<p class="pull-left"><b>Data Unit Kerja Eselon II</b></p>
		<ul class="nav nav-tabs pull-right">
			<li class="active">
				<a data-toggle="tab" href="#anev_e2-content">
				   <i class="fa fa-cogs"></i> Data di Anev
				</a>
			</li>
			<li class="">
				<a data-toggle="tab" href="#eperform_e2-content">
	...
	<div class="panel-body">
		<div class="tab-content">
		   <div class="tab-pane fade active in" id="anev_e2-content">
			<!--main content start-->
				...
				<div class="tab-pane fade" id="eperform_e2-content">
					<div class="row">
						<div class="col-sm-12">
							<div class="pull-left">
					...
					<br />
					<div class="adv-table">
					<table class="display table table-bordered table-striped" id="eperform_e2-tbl">
					 <thead>
						<tr>
							<th>Kode</th>
							<th>Nama Unit Kerja</th>
