	...
	<script>
        ...
        <?php else: ?>
            ...
            <input type="hidden" name="kegiatan" value="<?=$data[0]->kode_kegiatan?>" />
        	<div class="form-group">
                <label class="col-sm-4 control-label">Nama Kegiatan</label>
                <div class="col-sm-8">
                	<textarea name="deskripsi" readonly="readonly" rows="2" class="form-control input-sm"><?=$data[0]->nama_kegiatan?></textarea>
                </div>
            </div>
		<?php endif; ?>
