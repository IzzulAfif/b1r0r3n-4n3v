...
{ 
	...
	function get_all($params){
		...
		$sql = "select m.*,skl.sasaran_kl, iku.deskripsi,iku.satuan  from anev_matriks_pembangunan m left join anev_sasaran_kl skl on m.kode_sasaran_kl = skl.kode_sasaran_kl
left join anev_iku_eselon1 iku on m.kode_iku_e1 = iku.kode_iku_e1 and m.tahun = iku.tahun".$where;
		$sql .= ' order by m.kode_sasaran_kl,m.kode_iku_e1, m.tahun';
