...
{ 
	...
	function get_all($params){
		...
		$sql .= "  f.kode_sk_e2 order by f.tahun desc, f.kode_sk_e2";
	...
	function get_renstra($params){
		...
		$sql = "select distinct kode_sk_e2, deskripsi,nama_e2,kode_e1 from anev_sasaran_kegiatan f  inner join anev_eselon2 e on e.kode_e2=f.kode_e2 and f.tahun between left(e.tahun_renstra,4) and right(e.tahun_renstra,4) ".$where;
		$sql .= " order by f.kode_e2,kode_sk_e2";
		return $this->mgeneral->run_sql($sql);
	}
