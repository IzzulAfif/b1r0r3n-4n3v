...
{ 
	...
	function get_rincian_paket_pekerjaan($params){
		$where = ' where 1=1 ';
		if (isset($params)){
			if (isset($params['i.kdlokasi'])) $where .= " and i.kdlokasi='".$params['kdlokasi']."'";
			if (isset($params['i.kode_program'])) $where .= " and i.kode_program='".$params['kode_program']."'";
			if (isset($params['i.kode_kegiatan'])) $where .= " and i.kode_kegiatan='".$params['kode_kegiatan']."'";
			if (isset($params['i.tahun'])) $where .= " and i.tahun='".$params['tahun']."'";
		}
