...
{ 
	...
	function get_all($params){
		...
		$sql = "select 	f.tahun_renstra, f.kode_e1, f.kode_visi_e1, f.visi_e1 , e1.nama_e1 from anev_visi_eselon1 f inner join anev_eselon1 e1 on e1.kode_e1=f.kode_e1 and e1.tahun_renstra = f.tahun_renstra ".$where." ORDER BY f.kode_e1";
	...
	function get_where($params){
		...
		$sql = "select f.*, e1.nama_e1 from anev_visi_eselon1 f inner join anev_eselon1 e1 on e1.kode_e1=f.kode_e1 and e1.tahun_renstra = f.tahun_renstra".$where;
