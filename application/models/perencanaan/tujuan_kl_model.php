...
class Tujuan_kl_model extends CI_Model
{ 
	...
	function get_all($params){
		...
		$sql = "select f.*, kl.nama_kl from anev_tujuan_kl f inner join anev_kl kl on f.kode_kl=kl.kode_kl and f.tahun_renstra= kl.tahun_renstra ".$where;
