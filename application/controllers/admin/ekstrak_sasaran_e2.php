...
class Ekstrak_sasaran_e2 extends CI_Controller {
	
	function __construct() 
	{	
		parent::__construct();
		$this->load->library('datatables');
		$this->load->model('/admin/ekstrak_sasaran_e2_model','sasaran');
	...
	function loadpage($id,$periode,$tahun)
	{
		...
		$data['tahun']	= $tahun;	
		echo $this->load->view('admin/ekstrak_sasaran_e2_v',$data,true); #load konten template file		
	}
