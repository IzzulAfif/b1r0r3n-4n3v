...
class Capaian_kinerja_eselon1 extends CI_Controller {
	...
	function get_capaian($tahun,$e1,$ajaxCall=true,$forExcel=false){
		$dataAll = array();
	...
	public function excel($tahun,$e1){
		...
		$this->excel->getActiveSheet()->setTitle('Capaian Kinerja Eselon I');
		$this->excel->getActiveSheet()->getStyle('A1')->getFont()->setSize(20);
		$this->excel->getActiveSheet()->getStyle('A1')->getFont()->setBold(true);
		$this->excel->getActiveSheet()->getStyle('A2')->getFont()->setBold(true);
		$this->excel->getActiveSheet()->mergeCells('A1:E1');
		$this->excel->getActiveSheet()->setCellValue('A1', 'REALISASI CAPAIAN KINERJA '.strtoupper($this->mgeneral->getValue("nama_e1",array('kode_e1'=>$e1,'tahun_renstra'=>$tahun),"anev_eselon1")));
		...
		$posisiRow = 4;
		$data 		= $this->get_capaian($tahun,$e1,false,true);
